...
public class BookingsConstants {
	...
	private static Map<String, String> prepareStatusRoleLocalizationKeyMap() {
		...
		map.put(WorkFlowConfigs.STATUS_ASSIGNED + "|" + BookingsConstants.ROLE_CITIZEN, LOCALIZATION_CODE_ASSIGN_CITIZEN);
		map.put(WorkFlowConfigs.STATUS_ASSIGNED + "|" + BookingsConstants.ROLE_EMPLOYEE, LOCALIZATION_CODE_ASSIGN_EMPLOYEE);
		map.put(WorkFlowConfigs.STATUS_REJECTED + "|" + BookingsConstants.ROLE_CITIZEN, LOCALIZATION_CODE_REJECT_CITIZEN);
		map.put(WorkFlowConfigs.STATUS_RESOLVED + "|" + BookingsConstants.ROLE_CITIZEN, LOCALIZATION_CODE_RESOLVE_CITIZEN);
		map.put(WorkFlowConfigs.STATUS_CLOSED + "|" + BookingsConstants.ROLE_EMPLOYEE, LOCALIZATION_CODE_CLOSE_EMPLOYEE);
	...
	private static Map<String, String> prepareActionRoleLocalizationKeyMap() {
		...
		Map<String, String> map = new HashMap<>();
		map.put(WorkFlowConfigs.ACTION_REOPEN + "|" + BookingsConstants.ROLE_EMPLOYEE, LOCALIZATION_CODE_REOPEN_EMPLOYEE);
		map.put(WorkFlowConfigs.ACTION_REOPEN + "|" + BookingsConstants.ROLE_CITIZEN, LOCALIZATION_CODE_REOPEN_CITIZEN);
		map.put(WorkFlowConfigs.ACTION_REASSIGN + "|" + BookingsConstants.ROLE_CITIZEN, LOCALIZATION_CODE_REASSIGN_CITIZEN);
		map.put(WorkFlowConfigs.ACTION_REASSIGN + "|" + BookingsConstants.ROLE_EMPLOYEE, LOCALIZATION_CODE_REASSIGN_EMPLOYEE);
