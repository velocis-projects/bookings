...
public class WorkFlowConfigs {
	...
	private static Map<String, List<String>> prepareRoleActionMap() {
		...
		Map<String, List<String>> map = new HashMap<>();
		map.put(BookingsConstants.ROLE_EMPLOYEE, Arrays.asList(ACTION_RESOLVE, ACTION_REQUEST_FOR_REASSIGN));
		map.put(BookingsConstants.ROLE_CITIZEN, Arrays.asList(ACTION_OPEN, ACTION_CLOSE, ACTION_REOPEN));
		map.put(BookingsConstants.ROLE_GRO, Arrays.asList(ACTION_ASSIGN, ACTION_REJECT, ACTION_REASSIGN));
		map.put(BookingsConstants.ROLE_DGRO, Arrays.asList(ACTION_ASSIGN, ACTION_REJECT, ACTION_REASSIGN));
		map.put(BookingsConstants.ROLE_CSR, Arrays.asList(ACTION_OPEN, ACTION_CLOSE, ACTION_REOPEN));
		return map;
	}
	...
	private static Map<String, List<String>> prepareMapOfStatusAndNotificationReceptors(){
		...
		map.put(WorkFlowConfigs.STATUS_ASSIGNED, Arrays.asList(BookingsConstants.ROLE_CITIZEN, BookingsConstants.ROLE_EMPLOYEE));
		map.put(WorkFlowConfigs.STATUS_OPENED, Arrays.asList(BookingsConstants.ROLE_CITIZEN));
		map.put(WorkFlowConfigs.STATUS_REJECTED, Arrays.asList(BookingsConstants.ROLE_CITIZEN));
		map.put(WorkFlowConfigs.STATUS_RESOLVED, Arrays.asList(BookingsConstants.ROLE_CITIZEN));
		map.put(WorkFlowConfigs.STATUS_CLOSED, Arrays.asList(BookingsConstants.ROLE_EMPLOYEE));
	...
	private static Map<String, List<String>> prepareMapOfActionAndNotificationReceptors(){
		...
		map.put(WorkFlowConfigs.ACTION_REASSIGN, Arrays.asList(BookingsConstants.ROLE_CITIZEN, BookingsConstants.ROLE_EMPLOYEE));
		map.put(WorkFlowConfigs.ACTION_REOPEN, Arrays.asList(BookingsConstants.ROLE_CITIZEN));
